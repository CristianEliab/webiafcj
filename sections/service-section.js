...
import TextFeature from "../components/ui/text-feature"
    ...
    <section sx={{ variant: "section.services" }}>
      <Container sx={styles.containerBox}>
        <Box sx={styles.thumbnail}>
          <Image src="./service-thumb.png" alt="Thumbnail" />
          <Button
            sx={styles.videoBtn}
            onClick={handleClick}
          ...
          <Box sx={styles.shapeBox}>
            <Image src="/shape-pattern1.png" alt="Shape" />
          </Box>
        </Box>
